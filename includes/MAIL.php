 ...
 *                                                                                         *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
set_include_path(get_include_path() . PATH_SEPARATOR . dirname(__FILE__) . '/MAIL');

if (!class_exists('SMTP5')) require_once 'MAIL/SMTP5.php';
if (!class_exists('POP35')) require_once 'MAIL/POP35.php';
...
class MAIL {
	...
	public $SendMail = '/usr/sbin/sendmail.sendmail';
