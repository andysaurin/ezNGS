...
class browser extends NQ_Auth_User
{
	...
	public function __default()
	{
		...
		echo json_encode( $this->searchDir( SYSTEM_UPLOAD_ROOT."/{$this->user->username}" , $p, $f, -2) );

	}

	public function searchDir($base_dir="./",$p="",$f="",$allowed_depth=-1)
	{
		$contents=array();
